...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        totalbalanceresult = myview.findViewById(R.id.balance);
    ...
    private void calculateTotalBalance() {
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                totalIncomResult.setText(totalIncome + ".00");
                updateTotalBalance();
            }
        ...
        mExpenseDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                totalExpenseResult.setText(totalExpense + ".00");
                updateTotalBalance();
            }
    ...
    private void updateTotalBalance() {
        int totalIncome = Integer.parseInt(totalIncomResult.getText().toString().replace(".00", ""));
        int totalExpense = Integer.parseInt(totalExpenseResult.getText().toString().replace(".00", ""));
        int totalBalance = totalIncome - totalExpense;
        totalbalanceresult.setText(totalBalance + ".00");
    }
